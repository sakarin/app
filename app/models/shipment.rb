...
#    line_items.each {|line| line.update_attribute(:shipment_id, nil)}
  end
  ...
  def determine_state(order)
    ...
    return "pending" if self.inventory_units.any? { |unit| unit.canceled? }
  ...
  def ensure_correct_adjustment
    if adjustment
      ...
      unless self.order.payment_state == 'paid'
